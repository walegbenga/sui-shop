              ...
              <Menu.Item>
                {() => (
                  <div className="px-2 pb-2">
                    {/* walletFilter hides Enoki entries from this button
                        since we already have the Google button above     */}
                    <ConnectButton walletFilter={(w) => !isEnokiWallet(w)} />
                  </div>
                )}
              </Menu.Item>
            </div>
